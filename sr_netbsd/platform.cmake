...
list(APPEND gt_src_list sr_netbsd)
if(${bits} EQUAL 32)
...
# Compiler
set(CMAKE_C_FLAGS
  "${CMAKE_C_FLAGS} -ansi -fsigned-char -fPIC -Wmissing-prototypes -Wreturn-type -Wpointer-sign -fno-omit-frame-pointer -I/usr/pkg/include")
...
if(${bits} EQUAL 32)
  set(libmumpslibs "-lcrypt -lncurses -lexecinfo -lm -lc -lpthread -lrt")
else()
  set(libmumpslibs "-lelf -lcrypt -lncurses -lexecinfo -lm -lc -lpthread -lrt")
endif()
